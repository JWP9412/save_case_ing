...
대법원 나의 사건 조회 자동화 시스템 (Puppeteer + Python GUI) - v4.7.0
...
├── config.py                    설정 상수 (APP_VERSION = "4.7.0" 등)
...
상세 변경 이력: [00.CHANGELOG/CHANGELOG_v4.7.0.md](00.CHANGELOG/CHANGELOG_v4.7.0.md)  
