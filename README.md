...
대법원 나의 사건 조회 자동화 시스템 (Puppeteer + Python GUI) - v4.1.0
...
├── config.py                    설정 상수 (APP_VERSION = "4.1.0" 등)
...
1. **사건 목록 불러오기**
   ...
   - 사건 목록 시트 이름은 `config.py` 또는 앱 상단 설정(⚙)에서 지정할 수 있습니다.
...
상세 변경 이력: [00.CHANGELOG/CHANGELOG_v4.1.0.md](00.CHANGELOG/CHANGELOG_v4.1.0.md)  
