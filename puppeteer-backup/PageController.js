...
class PageController {
  ...
  async inputCaseNumber(caseNumber) {
    try {
      ...
      await this.page.type(inputSelector, caseNumber, { delay: 10 });
  ...
  async inputPartyName(partyName) {
    try {
      ...
      // 기존 내용 지우고 입력
      await this.page.click(inputSelector, { clickCount: 3 });
      await this.page.type(inputSelector, partyName, { delay: 10 });
  ...
  async handleCaptcha(caseNumber) {
    try {
      ...
      await this.page.click(inputSelector, { clickCount: 3 });
      await this.page.type(inputSelector, captchaInput, { delay: 10 });
