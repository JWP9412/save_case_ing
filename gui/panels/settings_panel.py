# -*- coding: utf-8 -*-
"""
설정 패널 (Settings Panel) — 레거시
===================================
메인 화면 「처리 설정」단락용 코드였습니다.

현재는 설정 창(`gui/dialogs/settings_dialog.py`)의 「처리 설정」탭으로 이동했으며,
`main_window`에서는 더 이상 호출하지 않습니다. 참고·복원용으로 파일만 유지합니다.
"""
